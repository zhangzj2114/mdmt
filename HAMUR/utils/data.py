...
class TorchDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print({k: v[index] for k, v in self.x.items()})
        # print(222222222222222222)
        # print(self.y.loc[[index]])
        # print(33333333333333333333)
        # print(self.y[['click', 'purchase']].loc[index].values.tolist())
        # print(44444444444444444444)
        # assert 0
        # print(self.y[:10])
        
        # return {k: v[index] for k, v in self.x.items()}, torch.tensor(self.y.loc[index, ['click', 'purchase']].values)
        # return {k: v[index] for k, v in self.x.items()}, self.y.loc[[index]]
